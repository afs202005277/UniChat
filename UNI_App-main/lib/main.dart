...
import 'package:uni/view/Pages/uni_chat_main_page.dart';
...
import 'view/Pages/all_chats_display.dart';
      ...
      child: MaterialApp(
          ...
          onGenerateRoute: (RouteSettings settings) {
            switch (settings.name) {
              ...
              case '/' + Constants.navChats:
                return PageTransition.makePageTransition(
                    page: UniChatPageView(), settings: settings);
            }
          }),
    );
  }
